...
- `description` (String) Admin provided description of the Device Configuration. <br/>
...
- `connected_apps_enabled` (Boolean) Setting to specify whether to allow ConnectedApps experience for this app. <br/>
- `credential_provider_role_state` (String) Indicates whether the app is allowed to act as a credential provider. Applies to Android 14 and above. Possible values are: 'notConfigured' and 'allowed'. When set to 'notConfigured', the Android OS will determine whether the app is allowed to act as a credential provider or not. / The Android credential provider role state for apps. <br/> _Provider_ allowed values are: `notConfigured` (Default. Indicates the app's ability to act as a credential provider has not been configured. When set to 'notConfigured', the Android OS will determine whether the app is allowed to act as a credential provider or not.), `allowed` (Indicates the app is allowed to act as a credential provider.), `unknownFutureValue` (Evolvable enumeration sentinel value. Do not use.).
