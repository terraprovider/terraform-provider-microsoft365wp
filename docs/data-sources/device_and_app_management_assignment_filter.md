...
- `description` (String) Optional description of the Assignment Filter. <br/>
...
- `role_scope_tags` (Set of String) Indicates role scope tags assigned for the assignment filter. <br/>
