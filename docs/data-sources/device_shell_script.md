...
- `block_execution_notifications` (Boolean) Does not notify the user a script is being executed <br/>
...
- `execution_frequency` (String) The interval for script to run. If not defined the script will run once <br/>
...
- `retry_count` (Number) Number of times for the script to be retried if it fails <br/>
