---
page_title: "microsoft365wp_device_management_script Data Source - microsoft365wp"
subcategory: "MS Graph: Device management"
---

# microsoft365wp_device_management_script (Data Source)
...
- `run_as_32_bit` (Boolean) A value indicating whether the PowerShell script should run as 32-bit <br/>
